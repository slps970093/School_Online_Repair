<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo site_url('admin'); ?>"><?php echo $webinfo['website_title']; ?></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        -->
        <li><a href="<?php echo site_url('admin/website'); ?>">網站基本設定</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="<?php echo site_url('admin/qrcode'); ?>">Qr-Code行動條碼報修</a></li>
            <li><a href="<?php echo site_url('admin/property/information'); ?>">財產資料</a></li>
            <!--
            <li class="divider"></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        -->
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">管理者(<?php $this->authhelper->show_login_name(); ?>)你好 <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
